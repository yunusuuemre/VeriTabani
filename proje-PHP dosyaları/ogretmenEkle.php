  ...
  <form action="">
    <table style="margin-left: 20px; margin-top: 20px;">
      <tr >
        ...
        <td ><input type="text" required class="form-control" style="font-size: large; display: inline-block;" ></td>
      </tr>
      <tr>
        <td><label class="form-label" style="font-size: x-large; display: inline-block;">Öğretmen Soy Adı </label></td>
        <td ><input type="text" required class="form-control" style="font-size: large; display: inline-block;"></td>
      </tr>
      <tr>
        <td><label class="form-label" style="font-size: x-large; display: inline-block;"> Öğretmen Alan </label></td>
        <td><input type="text" required class="form-control" style="font-size: large; display: inline-block;" ></td>
        </tr>
      <tr>
        <td><label class="form-label" style="font-size: x-large; display: inline-block;">Telefon Numarası  </label></td>
        <td ><input required type="text" class="form-control" style="font-size: large; display: inline-block;"></td>
      </tr>
      <tr>
        <td><label class="form-label" style="font-size: x-large; display: inline-block;">Tc No</label></td>
        <td ><input required type="text" class="form-control" style="font-size: large; display: inline-block;"></td>
      </tr>
      <tr>
        <td ><label class="form-label" style="font-size: x-large; display: inline-block;">Ücret</label></td>
        <td style="display: inline-block;"><input type="radio" required id="AylıkOdendi" name="Odeme" value="Ödendi"> <span style="font-size: x-large;"> Ödendi </span></td>
        <td style="display: inline-block;"><input type="radio" required id="AylıkOdenmedi" name="Odeme" value="Ödenmedi"><span style="font-size: x-large;"> Ödenmedi </span></td>
      </tr>
      <tr>
