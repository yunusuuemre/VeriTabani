...
<body style="background-color: gray;">
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
      ...
      <table class="table table-striped table-dark" style="margin-top: 30px; border-radius: 15px;">
        <thead>
          <tr>
            <th scope="col">Id</th>
        ...
        <tbody>
          <tr>
            <th scope="col">1</th>
            <th scope="col">Yunus Emre</th>
            <th scope="col">Akyay</th>
            <th scope="col">Oyun Geliştirme</th>
            <th scope="col">05464061959</th>
            <th scope="col">37033952990</th>
            <th scope="col">Veri Tabanından maaş miktarı alınacak</th>
          </tr>
         
        </tbody>
      </table>

      <button class="btn btn-danger"><a href="ogretmenEkle.html" style="color: black; font-size: x-large;">Öğretmen Ekle</a></button>
      <button class="btn btn-warning"><a href="ogretmenSil.html" style="color: black; font-size: x-large;">Öğretmen Sil</a></button>
      <button class="btn btn-danger"><a href="ogretmenArama.html" style="color: black; font-size: x-large;">Öğretmen Ara</a></button>
      <button class="btn btn-warning"><a href="ogretmenDuzenle.html" style="color: black; font-size: x-large;">Öğretmen Düzenle</a></button>
