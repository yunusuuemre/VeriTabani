      ...
      <table class="table table-striped table-dark" style="margin-top: 30px; border-radius: 15px;">
        ...
        <tbody>
          <tr>
            ...
            <th scope="col"><input type="checkbox" name="odeme">Ödeme yapıldı mı</th>
          </tr>
        </tbody>
      </table>

      <button class="btn btn-danger"><a href="ogrenciEkle.html" style="color: black; font-size: x-large;">Öğrenci Ekle</a></button>
      <button class="btn btn-warning"><a href="ogrenciSil.html" style="color: black; font-size: x-large;">Öğrenci Sil</a></button>
      <button class="btn btn-danger"><a href="ogrenciArama.html" style="color: black; font-size: x-large;">Öğrenci Ara</a></button>
      <button class="btn btn-warning"><a href="ogrenciDuzenle.html" style="color: black; font-size: x-large;">Öğrenci Düzenle</a></button>
