...
<body style="background-color: gray;">
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
      ...
      <h1>Düzenlemek istediğiniz öğretmenin bilgilerini giriniz</h1>
      ...
      <form action="">
        <table style="margin-left: 20px; margin-top: 20px;">
          ...
          <tr>
            <td><label class="form-label" style="font-size: x-large; display: inline-block;"> Öğretmenin Alanı </label></td>
            <td ><input type="text" required class="form-control" style="font-size: large; display: inline-block;"></td>
        </tr>
        </table>
      ...
      Öğretmen Bilgileri Yazılacak ve Düzenlemek için Ekle'deki ekranın aynısı gelecek (öncekini silip yeni olan bilgileri ekleyebilirsin)
