...
<body style="background-color: gray;">
  ...
  <h1>Aramak istediğiniz öğretmenin bilgilerini giriniz</h1>
  ...
  <form action="">
    <table style="margin-left: 20px; margin-top: 20px;">
      ...
      <tr>
        <td><label class="form-label" style="font-size: x-large; display: inline-block;"> Öğretmen Alanı </label></td>
        <td ><input type="text" required class="form-control" style="font-size: large; display: inline-block;"></td>
      </tr>
    </table>
  ...
  VARSA "Öğretmen VARDIR" YAZIP Bilgilerini Döndürecek
