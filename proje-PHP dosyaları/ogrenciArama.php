...
<body style="background-color: gray;">
  ...
  <h1>Aramak istediğiniz öğrencinin bilgilerini giriniz</h1>

  <form action="">
    <table style="margin-left: 20px; margin-top: 20px;">
      <tr >
        <td><label class="form-label" style="font-size: x-large; display: inline-block; "> Öğrenci Adı</label></td>
  ...
  VARSA "ÖĞRENCİ VARDIR" YAZIP Bilgilerini Döndürecek
