...
<body style="background-color: gray;">
  ...
  <h1>Aylık Gelir - Gider Durumu</h1>

  <table class="table table-striped table-dark" style="margin-top: 30px; border-radius: 15px;">
    <thead>
      <tr>
        <th scope="col" style="text-align: center;">Gelir</th>
        <th scope="col" style="text-align: center;">Gider</th>
        <th scope="col" style="text-align: center;">Son Durum</th>
      </tr>
    </thead>
    <tbody>
      <tr>
        ...
        <th scope="col" style="text-align: center;"> 5-3 YAZMALI</th>
      </tr>
