...
<form action="">
  <table style="margin-left: 20px; margin-top: 20px;">
    ...
    <tr>
      ...
      <td colspan="7"><input required type="text" class="form-control" style="font-size: large; display: inline-block;"></td>
    </tr>
    <tr>
    ...
    <tr>
      <td ><label class="form-label" style="font-size: x-large; display: inline-block;">Aylık</label></td>
